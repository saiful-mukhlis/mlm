...
public class SplitButton extends JButton implements SwingConstants {
    ...
    public SplitButton(String text, Icon icon, JPopupMenu dropDownMenu) {
        // Add the JLabel...
    ...
    private void jXSplitButtonStateChanged(javax.swing.event.ChangeEvent evt) {
        if(popupVisible && !SplitButton.this.getModel().isSelected()){ 
            SplitButton.this.getModel().setSelected(true);
            return;
        } 
    }
    ...
    private void arrowLabelMouseClicked(java.awt.event.MouseEvent evt) {
        if (dropDownMenu != null) {
            int height = SplitButton.this.getHeight();
            ...
            dropDownMenu.show(SplitButton.this, 0, height);
        } else {
        ActionEvent e = null;
        e = new ActionEvent(SplitButton.this,
    ...
    private void dropDownMenuPopupMenuWillBecomeInvisible(PopupMenuEvent e){ 
        popupVisible = false; 
        SplitButton.this.getModel().setSelected(false); 
    } 
    ...
    private class ArrowIcon implements Icon {
        ...
        public int getIconHeight() {
            int ret = SplitButton.this.getSize().height;
            return(ret);
        }
    }
}
