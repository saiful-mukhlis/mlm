...
public class EditPanelAbs implements EditPanel {
	...
	protected List<WidgetEditObj> widgetEditObjs;
	...
	public void build(ODatabaseDocumentTx db) {
		...
		labelNote.setText(App.getT("Edit Data"));
	...
	public void afterSave() {
		for (WidgetEditObj w : widgetEditObjs) {
			w.editObj(model, index);
		}
		dispose(panel);
	}
